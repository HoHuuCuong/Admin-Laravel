...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <image src="{{ asset('').$pro->image }} " width="100px">
            </td>
             <td>{{$pro->created_at->format('m-d-y')}}</td>
             <td class="text-right">
                <a href="{{route('product.edit',$pro->id)}} " class="btn btn-sm btn-success  "><i class="fas fa-edit"></i>  </a>
                <a href="{{route('product.destroy',$pro->id)}} " class="btn btn-sm btn-danger btn_delete "><i class="fas fa-trash"></i>  </a>
             </td>
        </tr>
        @endforeach
    </tbody>
